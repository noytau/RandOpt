...
def parse_args():
    ...
    p.add_argument("--nA", type=int, default=200, help="held-out split A (checkpoint ranking; 200 matches the sweep)")
    p.add_argument("--nB", type=int, default=200, help="held-out split B (reported; 200 matches the sweep)")
